<script lang="ts">
  import { Avatar, Icon, iconLocation, iconMobile, iconMail } from "$ui/svg";
  import { Socials } from "$ui/navigation/social";
...
<!--
  @component
  Profile Card View component
  Displays the user's avatar and contact information.
  ...
  Props:
    ...
    | mail     | string | required | User's mail address  |
-->
<div id="profile">
